                                        ...
                                        <div class="row align-items-center top-menu-div">
                                            <div class="col-2">
                                                <a href="<?php echo get_site_url();?>" class="logo-a">
                                                    <img src="<?php echo get_site_url(); ?>/wp-content/uploads/2023/11/desktop-logonew.png"
                                                        alt="">
                                                </a>

                                                <a href="<?php echo get_site_url();?>" class="mobile-logo-a">
                                                    <img src="<?php echo get_site_url(); ?>/wp-content/uploads/2023/11/starseed-new-logo-300x300.png"
                                                        alt="">
                                                </a>
