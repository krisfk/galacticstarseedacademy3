...
<!-- <img class="left-star star7 fadein-ele animate__animated animate__fadeIn delay-2"
    ...
    src="<?php echo get_site_url(); ?>/wp-content/themes/starseed/assets/images/star<?php echo rand(0,10); ?>.png"
    alt="">
...
<div class="w-bg inner-container pt-5 pb-5 mt-lg-0 mt-md-0 mt-sm-0 mt-0  mb-5 line-height">
                ...
                <div class="about-div">
                    <div class="container">
                        ...
                        <div class="row align-items-center g-0 line-height">
                            <div class="col-12 text-start mobile-align content-txt-div">
    ...
    ?>
        ...
        ?>
                    ...
                    <div class="text-center mb-5">
                        <!-- cosmic-meditation-introduction -->
                        <!-- cosmic-meditation-playlist -->
